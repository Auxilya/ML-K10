...
public class Mekahh {
    ...
    public Mekahh(String nomor, String asma, String nama, String arti, int ayat, int urutan_turun, String nuzul, int ruku, String keterangan) {
        this.nomor = nomor;
        this.asma = asma;
        this.nama = nama;
        this.arti = arti;
    ...
    public String getInfoMekahh() {
        return infoMekahh;
    }

    public void setInfoMekahh(String infoMekahh) {
        this.infoMekahh = infoMekahh;
    }
}