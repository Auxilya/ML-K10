...
public class Mekah implements Serializable {
    ...
    public Mekah(String nomor, String asma, String nama, String arti, String ayat, String urutan_turun, String nuzul, String ruku, String keterangan) {
        this.nomor = nomor;
        this.asma = asma;
        this.nama = nama;
        this.arti = arti;
