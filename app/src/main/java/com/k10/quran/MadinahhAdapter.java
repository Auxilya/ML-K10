...
public class MadinahhAdapter extends RecyclerView.Adapter<MadinahhAdapter.ViewHolder> {

    private Context context;
    private List<Madinahh> list;

    public MadinahhAdapter(Context context, List<Madinahh> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_madinah, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final Madinahh obj = list.get(position);
